...
// Aggiorna nav-link attiva su scroll e click
const sections = document.querySelectorAll("section");
const navLinks = document.querySelectorAll(".nav-link");

// Funzione di update robusta (si attiva in base alla sezione centrale del viewport)
...
// Aggiorna subito dopo il click su ogni nav-link
navLinks.forEach(link => {
  link.addEventListener("click", function() {
    // Delay per attendere il completamento dello scroll animato
    setTimeout(updateActiveNavLink, 400);
  });
});
