...
function updateActiveNavLink() {
  ...
  sections.forEach((section) => {
    ...
    // Se lo scroll è dentro questa sezione
  ...
  navLinks.forEach((link) => {
    ...
    // Confronta l'href del link con l'ID della sezione corrente
...
// Triggera quando scorri
window.addEventListener("scroll", updateActiveNavLink);

// Triggera al caricamento della pagina
document.addEventListener("DOMContentLoaded", () => {
  updateActiveNavLink();
});

// Triggera quando clicchi su un link
navLinks.forEach((link) => {
