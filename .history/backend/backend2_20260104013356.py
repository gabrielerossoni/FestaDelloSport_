...
# Configurazione CORS
# In sviluppo, puoi usare CORS(app) per permettere tutte le origini (NON in produzione!)
# Per produzione, usa la configurazione con ALLOWED_ORIGINS
CORS(app, resources={
    r"/api/*": {
...
# Fallback: se l'origine non è in ALLOWED_ORIGINS, logga un warning ma non bloccare (solo per debug)
# In produzione, rimuovi questo e usa solo ALLOWED_ORIGINS
origins=ALLOWED_ORIGINS)
PORT = 3001
