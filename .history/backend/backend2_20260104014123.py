...
def start_server():
    try:
        ...
        print(f"[CONFIG] Configurazione tavoli: {len(TAVOLI_CONFIG['standard'])} prenotabili, {len(TAVOLI_CONFIG['riservati'])} riservati")# Per produzione, usa Gunicorn invece di app.run()
