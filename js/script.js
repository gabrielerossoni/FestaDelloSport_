    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateCountdown() {
            ...
            if (diff > 0) {
                ...
                document.getElementById('countdown-timer').innerHTML = '<span class="text-3xl text-yellow-600">La festa è iniziata!</span>';
            }
        }
        updateCountdown();
  ...
  function mostraErrore(msg) {
    ...
    bottone.addEventListener("animationend", () => {
  ...
  // mostraErrore("Compila tutti i campi obbligatori.");
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    const bookedTables = ['1', '2', '41', '42', '43', '44', '45', '46', '47', '48'];
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function loadFeedbacks() {
            try {
                    ...
                    data.data.forEach(feedback => {
                        ...
                        feedbackElement.innerHTML = `
                            <div class="flex items-center mb-2">
                                <div class="text-yellow-500">${createStars(rating)}</div>
                ...
                const loadingDiv = document.getElementById('feedback-loading');
                loadingDiv.innerHTML = '<p class="text-red-500">Errore nel caricamento dei feedback.</p>';
            }
        }
    ...
    document.querySelectorAll('.faq-question').forEach(btn => {
        ...
        document.getElementById('close-attention-popup').addEventListener('click', function() {
